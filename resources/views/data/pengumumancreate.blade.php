    ...
    <div class="content">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="/pengumumanstore" method="POST" enctype="multipart/form-data" >  
                        @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="namakegiatan" class="form-control input-square" id="squareInput" placeholder="nama kegiatan">
                    </div>
                    <div class="form-group">
                        <label for="squareInput">Judul</label>
                        <input type="text" name="judul" class="form-control input-square" id="squareInput" placeholder="judul">
                    </div>
                    <div class="form-group">
