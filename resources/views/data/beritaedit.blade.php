    ...
    <div class="content">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="/beritaupdate/{{ $data->id }}" method="POST" enctype="multipart/form-data" >  
                        @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="namaberita" value="{{$data->namaberita}}" class="form-control input-square" id="squareInput" placeholder="nama kegiatan">
                    </div>
                    <div class="form-group">
